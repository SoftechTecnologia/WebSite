...
var sevenZipConj=conjProgIni+"sZip(0)"+conjProgIr+"7-zip</a>: Manipulador de arquivos compactos;</p>";//Função
var winProg=conjProgIni+"winApp(0)"+conjProgIr+"Apps Windows</a>: Programas de tratamento;</p>";//Função
var acessoRemoto=conjProgIni+"remAcces(0)"+conjProgIr+"Acesso Remoto</a>: Programas de acesso remoto;</p>";
...
var mediaPlayerConj=conjProgIni+"mPlayer(1)"+conjProgIr+"Media Player Classic</a>: Player de vídeo;</p>";//Função
var mse=progIni+"http://goo.gl/HwjJbF"+progDown+"Microsoft Security Essentials</a>: Antivírus;</p>";
var browsers=conjProgIni+"naveg(0)"+conjProgIr+"Browsers</a>: Navegadores de Web;</p>";//Função
...
var paginas=[
		[// Windows
			stSupport+sevenZipConj+winProg+acessoRemoto+browsers+ccleaner,//página 1
			cdburner+cpuz+hwmonitor+lofficeWin+mediaPlayerConj+mse,//página 2
			nppp+silverlight+pdfarc+recuva+unlocker+webCam,//página 3
			utorrent//página 4
		],[// Mac
			lofficeMac//página 1
		]
