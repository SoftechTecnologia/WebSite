		...
		<div id="corpo" style="width:100%">
			...
			<div id="meio">
				<fieldset id="texto">
					...
					<p>Caso você ache que esteja se encontrando com esta página por engano, por favor, nos comunique no <a href="javascript:chatlink();" class="linkintext">Chat Online</a> ou pelo formulário de e-mail à direita.</p>
